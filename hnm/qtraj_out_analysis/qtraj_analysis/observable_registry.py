...
OBSERVABLE_REGISTRY: Dict[str, TheoryObservableSpec] = {
    "auau200_raavsnpart": TheoryObservableSpec(
        ...
        acceptance="STAR acceptance: |y| < 1, pT < 10 GeV.",
        theory_note="0 < pT < 10 GeV, |y| < 1",
        ...
        experimental_observables=(
            ...
            ExperimentalObservableSpec(
                ...
                state="Y(1S)",
                observable_type="RAA_vs_npart",
                acceptance="|y| < 1, pT < 10 GeV, 0-60% centrality integrated",
                sources=(_ref("inputs/experimental_data/rhic/AuAu200GeV/minbias_star_upsilon1s.csv"),),
                is_minbias=True,
                note="Dedicated min-bias side-panel point (0-60% centrality).",
            ),
            ExperimentalObservableSpec(
                experiment="STAR",
                state="Y(2S)",
                observable_type="RAA_vs_npart",
                acceptance="|y| < 1, pT < 10 GeV, 0-60% centrality integrated",
                sources=(_ref("inputs/experimental_data/rhic/AuAu200GeV/minbias_star_upsilon2s.csv"),),
                is_minbias=True,
                note="Dedicated min-bias side-panel point (0-60% centrality).",
            ),
            ExperimentalObservableSpec(
                ...
                observable_type="RAA_vs_npart",
                acceptance="|y| < 1, pT < 10 GeV, 0-60% centrality integrated",
                sources=(_ref("inputs/experimental_data/rhic/AuAu200GeV/minbias_star_upsilon3s.csv"),),
                is_minbias=True,
                upper_limit=True,
                note="95% CL upper limit dedicated to min-bias side panel (0-60% centrality).",
            ),
        ),
    ),
    "auau200_raavspt": TheoryObservableSpec(
        ...
        acceptance="STAR acceptance: |y| < 1, 0-60% centrality, pT < 10 GeV.",
        theory_note="0-60% Centrality, |y| < 1",
    ...
    "auau200_raavsy": TheoryObservableSpec(
        ...
        acceptance="Prediction only on the RHIC notebook rapidity grid: -5.5 <= y <= 5.5 with Delta y = 1.",
        theory_note="0-60% Centrality, 0 < pT < 10 GeV",
    ...
    "pbpb2760_raavsnpart": TheoryObservableSpec(
        ...
        state="1S,2S,3S",
        observable_type="RAA_vs_npart",
        acceptance="ALICE: 2.5 < y < 4, pT > 0 GeV; CMS: |y| < 2.4.",
        theory_note="0 < pT < 40 GeV, |y| < 2.4",
        ...
        experimental_observables=(
            ...
            ExperimentalObservableSpec(
                ...
                state="Upsilon(1S)",
                observable_type="RAA_vs_npart",
                acceptance="|y| < 2.4, 0-100% centrality integrated",
                sources=(_ref("inputs/experimental_data/lhc/PbPb2.76TeV/minbias_cms_upsilon1s.csv"),),
                is_minbias=True,
                note="Dedicated min-bias side-panel point (0-100% centrality).",
            ),
            ExperimentalObservableSpec(
                experiment="CMS",
                state="Upsilon(2S)",
                observable_type="RAA_vs_npart",
                acceptance="|y| < 2.4, 0-100% centrality integrated",
                sources=(_ref("inputs/experimental_data/lhc/PbPb2.76TeV/minbias_cms_upsilon2s.csv"),),
                is_minbias=True,
                note="Dedicated min-bias side-panel point (0-100% centrality).",
            ),
            ExperimentalObservableSpec(
                ...
                observable_type="RAA_vs_npart",
                acceptance="|y| < 2.4, 0-100% centrality integrated",
                sources=(_ref("inputs/experimental_data/lhc/PbPb2.76TeV/minbias_cms_upsilon3s.csv"),),
                is_minbias=True,
                upper_limit=True,
                note="95% CL upper limit dedicated to min-bias side panel (0-100% centrality).",
            ),
        ),
        issues=(
            RegistryIssue(
    ...
    "pbpb2760_raavspt": TheoryObservableSpec(
        ...
        state="1S,2S,3S",
        observable_type="RAA_vs_pt",
        acceptance="CMS: |y| < 2.4, 0-100% centrality.",
        theory_note="0-100% Centrality, |y| < 2.4",
    ...
    "pbpb2760_raavsy": TheoryObservableSpec(
        ...
        state="1S,2S,3S",
        observable_type="RAA_vs_y",
        acceptance="ALICE: 2.5 < y < 4, pT > 0 GeV, 0-90% centrality; CMS: |y| < 2.4, 0-100% centrality.",
        theory_note="0-100% Centrality, 0 < pT < 40 GeV",
    ...
    "pbpb2760_ratio21vsnpart": TheoryObservableSpec(
        observable_id="pbpb2760_ratio21vsnpart",
        system="PbPb",
        energy_label="2.76 TeV",
        state="(2S/1S)_AA/(2S/1S)_pp",
        observable_type="double_ratio_vs_npart",
        acceptance="Prediction only: generated from PbPb 2.76 TeV datafile-avg bundles (no experimental overlay).",
        theory_note="0 < pT < 40 GeV, |y| < 2.4",
        published_figure=_ref(
            "inputs/qtraj_inputs/PbPb2760/archive/raaCalculator-trajectories.nb",
            note="Local archived notebook used as historical reference only.",
        ),
        mathematica_sources=(),
        datafile_sources=(
            _ref("inputs/qtraj_inputs/PbPb2760/input/lhc-2.76-3d-k3/datafile-avg.gz"),
        ...
        issues=(
            RegistryIssue(
                code="pbpb2760_ratio_prediction_only",
                message=(
                    "This 2.76 TeV double-ratio observable is exported as a Python prediction from local datafile-avg inputs "
                    "and is not a parity-locked Mathematica reference curve."
                ),
                sources=(
                    _ref("inputs/qtraj_inputs/PbPb2760/archive/raaCalculator-trajectories.nb"),
                ),
            ),
        ),
    ),
    "pbpb2760_ratio31vsnpart": TheoryObservableSpec(
    ...
    "pbpb2760_ratio21vspt": TheoryObservableSpec(
    ...
    "pbpb5023_raavsnpart": TheoryObservableSpec(
        ...
        state="1S,2S,3S",
        observable_type="RAA_vs_npart",
        acceptance="ALICE: 2.5 < y < 4; ATLAS: |y^mumu| < 1.5, pT^mumu < 30 GeV, 0-80% centrality; CMS: |y| < 2.4, pT < 30 GeV.",
        theory_note="0 < pT < 30 GeV, |y| < 2.4",
        published_figure=_ref("inputs/qtraj_inputs/arXiv-2305.17841v2/figures/5.02TeV/raavsnpart-lhc-3d.pdf"),
        mathematica_sources=(),
        datafile_sources=(
            _ref("inputs/qtraj_inputs/PbPb5023/lhc3d-k3/datafile.gz"),
            _ref("inputs/qtraj_inputs/PbPb5023/lhc3d-k4/datafile.gz"),
        ),
        grid=_grid(
            "Npart",
            "centers",
        ...
        experimental_observables=(
            ...
            ExperimentalObservableSpec(
                ...
                state="Upsilon(1S)",
                observable_type="RAA_vs_npart",
                acceptance="|y| < 2.4, pT < 30 GeV, 0-100% centrality integrated",
                sources=(_ref("inputs/experimental_data/lhc/PbPb5TeV/minbias_cms_upsilon1s.csv"),),
                is_minbias=True,
                note="Dedicated min-bias side-panel point (0-100% centrality).",
            ),
            ExperimentalObservableSpec(
                ...
                observable_type="RAA_vs_npart",
                acceptance="|y| < 2.4, pT < 30 GeV, 0-100% centrality integrated",
                sources=(_ref("inputs/experimental_data/lhc/PbPb5TeV/minbias_cms_upsilon2s.csv"),),
                is_minbias=True,
                note="Dedicated min-bias side-panel point (0-100% centrality).",
            ),
        ),
    ...
    "pbpb5023_ratio21vsnpart": TheoryObservableSpec(
        ...
        state="(2S/1S)_AA/(2S/1S)_pp",
        observable_type="double_ratio_vs_npart",
        acceptance="ATLAS: |y^mumu| < 1.5, pT^mumu < 30 GeV, 0-80% centrality; CMS: |y| < 2.4, pT < 30 GeV, pT^mu > 4 GeV.",
        theory_note="0 < pT < 30 GeV, |y| < 2.4",
    ...
    "pbpb5023_ratio31vsnpart": TheoryObservableSpec(
        ...
        state="(3S/1S)_AA/(3S/1S)_pp",
        observable_type="double_ratio_vs_npart",
        acceptance="CMS 3S/1S limits: |y| < 2.4, pT < 30 GeV, pT^mu > 4 GeV; ATLAS proxy: |y^mumu| < 1.5, pT^mumu < 30 GeV, 0-80% centrality.",
        theory_note="0 < pT < 30 GeV, |y| < 2.4",
    ...
    "pbpb5023_raavspt": TheoryObservableSpec(
        ...
        state="1S,2S,3S",
        observable_type="RAA_vs_pt",
        acceptance="ALICE: 2.5 < y < 4, 0-90% centrality; ATLAS: |y^mumu| < 1.5, pT^mumu < 30 GeV, 0-80% centrality; CMS: |y| < 2.4 (1S: 0-100%, 2S/3S: 0-90%).",
        theory_note="0-100% Centrality, |y| < 2.4",
    ...
    "pbpb5023_ratio21vspt": TheoryObservableSpec(
        ...
        state="(2S/1S)_AA/(2S/1S)_pp",
        observable_type="double_ratio_vs_pt",
        acceptance="ATLAS: |y^mumu| < 1.5, pT^mumu < 30 GeV, 0-80% centrality; CMS: |y| < 2.4, 0-100% centrality, pT^mu > 4 GeV.",
        theory_note="0-100% Centrality, |y| < 2.4",
    ...
    "pbpb5023_ratio32vspt": TheoryObservableSpec(
        ...
        observable_type="double_ratio_vs_pt",
        acceptance="CMS: |y| < 2.4, 0-90% centrality.",
        theory_note="0-100% Centrality, |y| < 2.4",
    ...
    "pbpb5023_raavsy": TheoryObservableSpec(
        ...
        state="1S,2S,3S",
        observable_type="RAA_vs_y",
        acceptance="ALICE: 2.5 < y < 4, 0-90% centrality; ATLAS: |y^mumu| < 1.5, pT^mumu < 30 GeV, 0-80% centrality; CMS: |y| < 2.4.",
        theory_note="0-100% Centrality, 0 < pT < 30 GeV",
