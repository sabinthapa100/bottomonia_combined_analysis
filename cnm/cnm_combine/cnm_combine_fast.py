...
Optimized CNM combination module: nPDF × (eloss × Cronin pT broadening).
...
# Optional: imported inside from_defaults for RHIC
...
class CNMCombineFast(CNMCombineBase):
    """
    Optimized subclass of CNMCombine.
    ...
    def from_defaults(
        ...
        # Select correct nPDF centrality module
        if energy == "200":
             import npdf_centrality_dAu as npdf_mod
        else:
             import npdf_centrality as npdf_mod

        df49_by_cent, K_by_cent, SA_all, Y_SHIFT = npdf_mod.compute_df49_by_centrality(
